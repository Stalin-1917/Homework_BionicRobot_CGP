...
public:
	...
	// nac: frequency
	inline void SetFrequency(int Index, double Value) {pFrequency[Index] = Value;} // nac: sets the material index here
	inline double GetFrequency(int Index) const {return pFrequency[Index];}
	inline void InitFrequencyArray(int Size) {pFrequency = new double[Size];}
	inline bool GetUsingFrequency(void) {return usingFrequency;}
	// int getNumNuerons() {return NumNuerons;}

	// nac: Duty Cycle
	inline void SetDutyCycle_n2p(int Index, double Value) {pDutyCycle_n2p[Index] = Value;} // nac: sets the material index here
	inline double GetDutyCycle_n2p(int Index) const {return pDutyCycle_n2p[Index];}
	inline void InitDutyCycle_n2pArray(int Size) {pDutyCycle_n2p = new double[Size];}
	inline bool GetUsingDutyCycle_n2p(void) {return usingDutyCycle_n2p;}
	// int getNumNuerons() {return NumNuerons;}

	// nac: Duty Cycle
	inline void SetDutyCycle_p2n(int Index, double Value) {pDutyCycle_p2n[Index] = Value;} // nac: sets the material index here
	inline double GetDutyCycle_p2n(int Index) const {return pDutyCycle_p2n[Index];}
	inline void InitDutyCycle_p2nArray(int Size) {pDutyCycle_p2n = new double[Size];}
	inline bool GetUsingDutyCycle_p2n(void) {return usingDutyCycle_p2n;}
	// int getNumNuerons() {return NumNuerons;}

	// nac: Segment
	inline void SetSegment(int Index, double Value) {pSegment[Index] = Value;} // nac: sets the material index here
	inline int GetSegment(int Index) const {return pSegment[Index];}
	inline void InitSegmentArray(int Size) {pSegment = new int[Size];}
	inline bool GetUsingSegment(void) {return usingSegment;}

	// nac: peak time n2p  
	inline void SetPeakTime(int Index, double Value) {pPeakTime[Index] = Value;} // nac: sets the material index here
	inline double GetPeakTime(int Index) const {return pPeakTime[Index];}
	inline void InitPeakTimeArray(int Size) {pPeakTime = new double[Size];}
	inline bool GetUsingPeakTime(void) {return usingPeakTime;}

	// nac: peak time p2n  
	inline void SetPeakTime_negative(int Index, double Value) {pPeakTime_negative[Index] = Value;} // nac: sets the material index here
	inline double GetPeakTime_negative(int Index) const {return pPeakTime_negative[Index];}
	inline void InitPeakTime_negativeArray(int Size) {pPeakTime_negative = new double[Size];}
	inline bool GetUsingPeakTime_negative(void) {return usingPeakTime_negative;}
	// int getNumNuerons() {return NumNuerons;}
...
protected:
	...
	bool usingDutyCycle_n2p;
	double *pDutyCycle_n2p;

	bool usingDutyCycle_p2n;
	double *pDutyCycle_p2n;
	
	bool usingPeakTime;
	double *pPeakTime;

	bool usingPeakTime_negative;
	double *pPeakTime_negative;
...
public:
	...
	inline void SetFrequency(int Index, double Value) {Structure.SetFrequency(Index,Value);} // nac: sets the material index here
	inline double GetFrequency(int Index) const {return Structure.GetFrequency(Index);}
	inline void InitFrequencyArray(int Size) {Structure.InitFrequencyArray(Size);}
	inline bool GetUsingFrequency(void) {return Structure.GetUsingFrequency();}

	inline void SetDutyCycle_n2p(int Index, double Value) {Structure.SetDutyCycle_n2p(Index,Value);} // nac: sets the material index here
	inline double GetDutyCycle_n2p(int Index) const {return Structure.GetDutyCycle_n2p(Index);}
	inline void InitDutyCycle_n2pArray(int Size) {Structure.InitDutyCycle_n2pArray(Size);}
	inline bool GetUsingDutyCycle_n2p(void) {return Structure.GetUsingDutyCycle_n2p();}

	inline void SetDutyCycle_p2n(int Index, double Value) {Structure.SetDutyCycle_p2n(Index,Value);} // nac: sets the material index here
	inline double GetDutyCycle_p2n(int Index) const {return Structure.GetDutyCycle_p2n(Index);}
	inline void InitDutyCycle_p2nArray(int Size) {Structure.InitDutyCycle_p2nArray(Size);}
	inline bool GetUsingDutyCycle_p2n(void) {return Structure.GetUsingDutyCycle_p2n();}

	inline void SetPeakTime(int Index, double Value) {Structure.SetPeakTime(Index,Value);} // nac: sets the material index here
	inline double GetPeakTime(int Index) const {return Structure.GetPeakTime(Index);}
	inline void InitPeakTimeArray(int Size) {Structure.InitPeakTimeArray(Size);}
	inline bool GetUsingPeakTime(void) {return Structure.GetUsingPeakTime();}

	inline void SetPeakTime_negative(int Index, double Value) {Structure.SetPeakTime_negative(Index,Value);} // nac: sets the material index here
	inline double GetPeakTime_negative(int Index) const {return Structure.GetPeakTime_negative(Index);}
	inline void InitPeakTime_negativeArray(int Size) {Structure.InitPeakTime_negativeArray(Size);}
	inline bool GetUsingPeakTime_negative(void) {return Structure.GetUsingPeakTime_negative();}

	inline void SetSegment(int Index, double Value) {Structure.SetSegment(Index,Value);} // nac: sets the material index here
	inline int GetSegment(int Index) const {return Structure.GetSegment(Index);}
	inline void InitSegmentArray(int Size) {Structure.InitSegmentArray(Size);}
	inline bool GetUsingSegment(void) {return Structure.GetUsingSegment();}
